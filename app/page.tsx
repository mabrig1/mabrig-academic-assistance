...
const services = [
  ...
  ["UNN Undergraduate Project Formatting", "Times New Roman 12pt, 1.5 spacing, justified academic layout, headings, references and project-ready Word formatting."],
